...
// XvcMainnetBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main XValue network.
var XvcMainnetBootnodes = []string{
	// XValue Foundation Go Bootnodes
...
// XvcTestnetBootnodes are the enode URLs of the P2P bootstrap nodes running on the
// XValue test network.
var XvcTestnetBootnodes = []string{
