...
// newCppEthereumGenesisSpec converts a go-xvalue genesis block into a Parity specific
// chain specification format.
func newCppEthereumGenesisSpec(network string, genesis *core.Genesis) (*cppEthereumGenesisSpec, error) {
	// Only ethash is currently supported between go-xvalue and cpp-xvalue
...
// newParityChainSpec converts a go-xvalue genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between go-xvalue and Parity
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	// Reconstruct the chain spec in Parity's format
...
// newPyEthereumGenesisSpec converts a go-xvalue genesis block into a Parity specific
// chain specification format.
