...
func (v *BlockValidator) ValidateBody(block *types.Block) error {
	//log.Debug("==========ValidateBody start==============") //TODO
...
func (v *BlockValidator) ValidateState(block, parent *types.Block, statedb *state.StateDB, receipts types.Receipts, usedGas uint64) error {
	//log.Debug("==========ValidateState start==============") //TODO
	header := block.Header()
	//log.Debug("==========ValidateState","usedGas",usedGas,"","=================") //TODO
	...
	//log.Debug("==========ValidateState","download block header.Root",header.Root,"","=================") //TODO
