...
func (c *Clique) Finalize(chain consensus.ChainReader, header *types.Header, state *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt) (*types.Block, error) {
	...
	//log.Debug("===========Clique.Finalize","header number",header.Number,"get header root ",header.Root,"","===========") //TODO
...
func (c *Clique) Seal(chain consensus.ChainReader, block *types.Block, results chan<- *types.Block, stop <-chan struct{}) error {
	...
	//log.Debug("===========Clique.Seal","sighash",string(sighash),"","===========") //TODO
	if err != nil {
		return err
	}
...
func (c *Clique) accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	//log.Debug("===========accumulateRewards","reward",reward,"","===========") //TODO
