...
func (t *Trie) TryGet(key []byte) ([]byte, error) {
	...
	//log.Debug("=========TryGet","key1",new(big.Int).SetBytes(key),"","===========")//TODO
	key = keybytesToHex(key)
        //fmt.Printf("========Trie.TryGet,key2 is %v========",new(big.Int).SetBytes(key))
	//log.Debug("=========TryGet","key2",new(big.Int).SetBytes(key),"","===========")//TODO
	//log.Debug("=========TryGet","old t.root",t.root,"","===========")//TODO
	value, newroot, didResolve, err := t.tryGet(t.root, key, 0)
	//log.Debug("=========TryGet","new t.root",t.root,"value",string(value),"","===========")//TODO
...
func (t *Trie) Update(key, value []byte) {
	//log.Debug("=================Update","key",string(key),"value",string(value),"","================")//TODO
...
func (t *Trie) TryUpdate(key, value []byte) error {
	//log.Debug("=================TryUpdate","key",string(key),"value",string(value),"","================")//TODO
	k := keybytesToHex(key)
	//log.Debug("=================TryUpdate","k",string(k),"","================")//TODO
	//log.Debug("=================TryUpdate","old t.root",t.root,"","================")//TODO
	if len(value) != 0 {
	...
	//log.Debug("=================TryUpdate","new t.root",t.root,"","================")//TODO
	return nil
}
...
func (t *Trie) Delete(key []byte) {
	//log.Debug("=================Delete","key",string(key),"","================")//TODO
...
func (t *Trie) Commit(onleaf LeafCallback) (root common.Hash, err error) {
	...
	//log.Debug("=================Trie.Commit success.================")//TODO
	t.root = cached
	t.cachegen++
