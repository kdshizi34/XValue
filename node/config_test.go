...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gxvc.ipc", false, filepath.Join(os.TempDir(), "gxvc.ipc")},
		{"data", "gxvc.ipc", false, "data/gxvc.ipc"},
		{"data", "./gxvc.ipc", false, "./gxvc.ipc"},
		{"data", "/gxvc.ipc", false, "/gxvc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gxvc.ipc", true, `\\.\pipe\gxvc.ipc`},
		{"data", "gxvc.ipc", true, `\\.\pipe\gxvc.ipc`},
		{"data", `\\.\pipe\gxvc.ipc`, true, `\\.\pipe\gxvc.ipc`},
	}
