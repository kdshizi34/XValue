...
var (
	...
	app = utils.NewApp(gitCommit, "the dccp-go command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2017-2019 The dccp-go Authors"
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	if ctx.GlobalBool(utils.MiningEnabledFlag.Name) || ctx.GlobalBool(utils.DeveloperFlag.Name) {
		...
		if err := stack.Service(&ethereum); err != nil {
			utils.Fatalf("XValue service not running: %v", err)
		}
