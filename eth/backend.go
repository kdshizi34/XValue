...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	if config.SyncMode == downloader.LightSync {
		return nil, errors.New("can't run xvc.XValue in light sync mode, use les.LightXValue")
	}
	...
	log.Info("Initialising XValue protocol", "versions", ProtocolVersions, "network", config.NetworkId)
