...
import (
	...
	"github.com/xvalue/go-xvalue/dashboard"
	"github.com/xvalue/go-xvalue/eth"
	"github.com/xvalue/go-xvalue/eth/downloader"
	"github.com/xvalue/go-xvalue/eth/gasprice"
	"github.com/xvalue/go-xvalue/ethdb"
	"github.com/xvalue/go-xvalue/ethstats"
	"github.com/xvalue/go-xvalue/les"
	"github.com/xvalue/go-xvalue/log"
	"github.com/xvalue/go-xvalue/metrics"
	"github.com/xvalue/go-xvalue/metrics/influxdb"
	"github.com/xvalue/go-xvalue/node"
	"github.com/xvalue/go-xvalue/p2p"
	"github.com/xvalue/go-xvalue/p2p/discover"
	"github.com/xvalue/go-xvalue/p2p/discv5"
	"github.com/xvalue/go-xvalue/p2p/nat"
	"github.com/xvalue/go-xvalue/p2p/netutil"
	"github.com/xvalue/go-xvalue/params"
	"github.com/xvalue/go-xvalue/xvalue/layer2"
	whisper "github.com/xvalue/go-xvalue/whisper/whisperv6"
...
var (
	...
	DccpFlag = cli.BoolFlag{
	        Name:  "dccp",
	        Usage: "Enable dccp feature",
	}
...
func SetDatadir (ctx *cli.Context) {
	log.Debug("=============SetDatadir==========")//TODO
	if path := ctx.GlobalString(DataDirFlag.Name); path != "" {
	    log.Debug("=============SetDatadir,","data dir path",path,"","==========")//TODO
	dccp.SetDatadir(path)
	}
}
...
func setBootstrapNodes(ctx *cli.Context, cfg *p2p.Config) {
	urls := params.XvcMainnetBootnodes
	switch {
	...
	case ctx.GlobalIsSet(NetworkIdFlag.Name):
		xvcnetworkid := ctx.GlobalUint64(NetworkIdFlag.Name)
		log.Debug("setBootstrapNodes", "xvcnetworkid", xvcnetworkid)
		if xvcnetworkid == 40400 {
			urls = params.XvcMainnetBootnodes
			log.Debug("setBootstrapNodes", "urls", urls)
		}else if xvcnetworkid == 40410 {
			urls = params.XvcTestnetBootnodes
			log.Debug("setBootstrapNodes", "urls", urls)
		}
