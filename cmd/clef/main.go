...
import (
	...
	"github.com/xvalue/go-xvalue/signer/core"
	"github.com/xvalue/go-xvalue/signer/rules"
	"github.com/xvalue/go-xvalue/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage XValue account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
