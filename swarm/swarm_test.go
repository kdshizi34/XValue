...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/gxvc.ipc",
			endpoint:    "/data/testnet/gxvc.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/gxvc.ipc",
			endpoint:    "/data/testnet/gxvc.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gxvc.ipc",
			endpoint:    "/data/testnet/gxvc.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gxvc.ipc",
			endpoint:    "/data/testnet/gxvc.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
