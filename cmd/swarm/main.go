...
import (
	...
	"github.com/xvalue/go-xvalue/cmd/utils"
	"github.com/xvalue/go-xvalue/common"
	"github.com/xvalue/go-xvalue/console"
	...
	"github.com/xvalue/go-xvalue/swarm"
	bzzapi "github.com/xvalue/go-xvalue/swarm/api"
	swarmmetrics "github.com/xvalue/go-xvalue/swarm/metrics"
	"github.com/xvalue/go-xvalue/swarm/tracing"
	sv "github.com/xvalue/go-xvalue/swarm/version"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:   "swap-api",
		Usage:  "URL of the XValue API provider to use to settle SWAP payments",
...
var app = utils.NewApp(gitCommit, "XValue Swarm")
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.xvalue/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.xvalue/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:             dbImport,
    ...
    swarm db import ~/.xvalue/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.xvalue/swarm/bzz-KEY/chunks -`,
				},
				{
					Action:             dbClean,
					CustomHelpTemplate: helpTemplate,
...
func bzzd(ctx *cli.Context) error {
	...
	//register BZZ as node.Service in the xvalue node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the xvalue node
