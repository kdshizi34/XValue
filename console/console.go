...
import (
	...
	"github.com/xvalue/go-xvalue/internal/jsre"
	"github.com/xvalue/go-xvalue/internal/web3ext"
...
func (c *Console) Welcome() {
	// Print some generic Gxvc metadata
	fmt.Fprintf(c.printer, "Welcome to the Gxvc JavaScript console!\n\n")
	c.jsre.Run(`
