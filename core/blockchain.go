...
func (bc *BlockChain) loadLastState() error {
	//log.Debug("=========BlockChain.loadLastState===========")//TODO
	// Restore the last known head block
	head := rawdb.ReadHeadBlockHash(bc.db)
	//log.Debug("=========BlockChain.loadLastState,", "head", head, "", "===========")//TODO
	if head == (common.Hash{}) {
	...
	//log.Debug("=========BlockChain.loadLastState,", "currentBlock", currentBlock, "", "===========")//TODO
	if currentBlock == nil {
		// Corrupt or empty database, init from scratch
	...
	//log.Debug("=========BlockChain.loadLastState,", "currentHeader", currentHeader, "", "===========")//TODO
	if head := rawdb.ReadHeadHeaderHash(bc.db); head != (common.Hash{}) {
		if header := bc.GetHeaderByHash(head); header != nil {
		//	log.Debug("=========BlockChain.loadLastState,", "header", header, "", "===========")//TODO
...
func (bc *BlockChain) insert(block *types.Block) {
	...
	if updateHeads {
	        //log.Debug("=========BlockChain.insert===========")//TODO
