...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/xvalue/go-xvalue

    go install github.com/xvalue/go-xvalue/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/xvalue/go-xvalue`.

Most likely you will be working from your fork of `go-xvalue`, let's say from `github.com/nirname/go-xvalue`. Clone or move your fork into the right place:

```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/xvalue/go-xvalue
```
